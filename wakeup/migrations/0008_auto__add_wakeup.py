...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WakeUp'
        db.create_table(u'wakeup_wakeup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('call', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wakeup.Call'], unique=True, null=True, blank=True)),
            ('schedule', self.gf('django.db.models.fields.DateTimeField')()),
            ('datecreated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'wakeup', ['WakeUp'])


    def backwards(self, orm):
        # Deleting model 'WakeUp'
        db.delete_table(u'wakeup_wakeup')
    ...
    models = {
        ...
        u'wakeup.wakeup': {
            'Meta': {'object_name': 'WakeUp'},
            'call': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wakeup.Call']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'datecreated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
