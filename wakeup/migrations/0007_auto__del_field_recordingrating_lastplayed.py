...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RecordingRating.lastplayed'
        db.delete_column(u'wakeup_recordingrating', 'lastplayed')


    def backwards(self, orm):
        # Adding field 'RecordingRating.lastplayed'
        db.add_column(u'wakeup_recordingrating', 'lastplayed',
