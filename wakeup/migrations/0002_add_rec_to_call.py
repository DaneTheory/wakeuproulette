...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Call.rec'
        db.add_column(u'wakeup_call', 'rec',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_call', null=True, to=orm['wakeup.Recording']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Call.rec'
        db.delete_column(u'wakeup_call', 'rec_id')
