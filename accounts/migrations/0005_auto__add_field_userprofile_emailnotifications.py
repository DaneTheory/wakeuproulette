...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.emailnotifications'
        db.add_column(u'accounts_userprofile', 'emailnotifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.emailnotifications'
        db.delete_column(u'accounts_userprofile', 'emailnotifications')
    ...
    models = {
        ...
        u'accounts.userprofile': {
            ...
            'emailnotifications': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'white': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        u'auth.group': {
