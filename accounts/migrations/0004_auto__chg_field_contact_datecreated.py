...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.datecreated'
        db.alter_column(u'accounts_contact', 'datecreated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Contact.datecreated'
        db.alter_column(u'accounts_contact', 'datecreated', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
